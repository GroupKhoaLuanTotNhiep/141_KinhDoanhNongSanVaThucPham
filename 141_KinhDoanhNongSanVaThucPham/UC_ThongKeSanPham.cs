    ...
    public partial class UC_ThongKeSanPham : UserControl
    {
        ...
        private void exportExcel_sapHetHan(DataGridView dv, string fileName)
        {
            ...
            try
            {
                ...
                worksheet.Range["D1"].ColumnWidth = 43.89;
                worksheet.Range["E1"].ColumnWidth = 10;
                worksheet.Range["F1"].ColumnWidth = 6.33;
                worksheet.Range["G1"].ColumnWidth = 6.33;
                worksheet.Range["H1"].ColumnWidth = 6.33;
                ...
                worksheet.Range["G6", "G" + (tkshh + 6)].HorizontalAlignment = 3;
                worksheet.Range["H6", "H" + (tkshh + 6)].HorizontalAlignment = 3;
